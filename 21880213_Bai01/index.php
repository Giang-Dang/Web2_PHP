    ...
    <div class="grid-container" id="main-container">
        ...
        <div class="grid-item box-A">
            <div class="box-A--text-area">
                ...
                ?>
                <hr>
                <p>Đã hoàn thành cài đặt môi trường WAMP và code editor (VS code):</p>
                <img src="../images/BT01_01.png" alt="Hình môi trường WAMP">
                <img src="../images/BT01_02.png" alt="Hình VS code">
            </div>
