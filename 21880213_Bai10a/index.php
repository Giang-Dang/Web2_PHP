    ...
    <div class="grid-container" id="main-container">
        ...
        <div class="grid-item box-A">
            <div class="box-A--text-area">
                ...
                ?>
                <hr>
                <a class="btn btn-success btn-l" href="./template_01.php">Link đến yêu cầu 2 (TLR3)</a>
                <a class="btn btn-success btn-l" href="./template_02.php">Link đến yêu cầu 3 (TLI2)</a>
            </div>
