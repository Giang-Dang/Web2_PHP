    ...
    <div class="grid-container" id="main-container">
        ...
        <div class="grid-item box-A">
            <div class="box-A--text-area">
                ...
                ?>
                <hr>
                <p>Đã hoàn thành tạo host của sinh viên (có ảnh profile và đủ thông tin theo yêu cầu) tại địa chỉ: </p>
                <a class="text-warning" href="http://dvngiang-21880213.infinityfreeapp.com/" target="_blank">http://dvngiang-21880213.infinityfreeapp.com/</a>
            </div>
