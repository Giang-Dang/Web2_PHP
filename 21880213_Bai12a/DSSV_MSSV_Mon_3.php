            ...
            <div class="box-A--text-area">
                ...
                <?php
                    if ($sosinhvien_dau_mon[$mamh] > 0) {
                        ...
                        print("</table>");
                        $avg_dtb_dau = number_format($sum_dtb_dau / $count_dau, 2);
                        $avg_diemmh_dau = number_format($sum_diemmh_dau / $count_dau, 2);
                ...
                <?php
                    if ($sosinhvien_rot_mon[$mamh] > 0) {
                        ...
                        print("</table>");
                        $avg_dtb_rot = number_format($sum_dtb_rot / $count_rot, 2);
                        $avg_diemmh_rot = number_format($sum_diemmh_rot / $count_rot, 2);
